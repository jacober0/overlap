...
describe('originaler redaktioneller Rezeptkatalog', () => {
  it('liefert 500 inhaltlich veröffentlichungsfähige Originalrezepte in 89 eigenständigen Batches', () => {
    expect(editorialRecipes.map(recipe => recipe.externalId)).toEqual([
      ...
      'overlap-394-lupinen-kuerbis-arancini',
      'overlap-395-seelachs-rote-bete-hirse-fishcakes',
      'overlap-396-ente-wirsing-buchweizen-pfanne',
      'overlap-397-pastinaken-linsen-dinkel-empanadas',
      'overlap-398-garnelen-polenta-paprika-spiesse',
      'overlap-399-kalb-spinat-graupen-baellchen',
      'overlap-400-kuerbis-adzuki-reisbaellchen',
      'overlap-401-zander-blumenkohl-dinkel-gratin',
      'overlap-402-schwarzwurzel-tofu-buchweizen-tarte',
      'overlap-403-huhn-fenchel-linsen-pastete',
      'overlap-404-rote-bete-quark-hirse-nocken',
      'overlap-405-makrele-bohnen-dinkel-pide',
      'overlap-406-tempeh-kohlrabi-reis-katsu',
      'overlap-407-rind-pilz-polenta-involtini',
      'overlap-408-kichererbsen-lauch-buchweizen-pie',
      'overlap-409-forelle-kuerbis-hafer-kloesse',
      'overlap-410-seitan-wirsing-hirse-paprikasch',
      ...
      'overlap-434-ziegenkaese-birnen-hirse-galette',
      'overlap-435-schellfisch-kuerbis-bohnen-potpie',
      'overlap-436-lupinen-rosenkohl-buchweizen-bowl',
      'overlap-437-haehnchen-rote-bete-polenta-roulade',
      'overlap-438-pilz-wirsing-dinkel-sarma',
      'overlap-439-garnelen-fenchel-hirse-paella',
      'overlap-440-rind-pastinaken-hafer-pie',
      'overlap-441-kartoffel-mangold-linsen-knish',
      'overlap-442-saibling-apfel-graupen-frikadellen',
      'overlap-443-tofu-blumenkohl-teff-curry',
      'overlap-444-schwein-kuerbis-buchweizen-rouladen',
      'overlap-445-bohnen-lauch-polenta-crostata',
      'overlap-446-kabeljau-spinat-hirse-kibbeh',
      'overlap-447-tempeh-rote-bete-dinkel-bao',
      'overlap-448-kalb-fenchel-linsen-lasagne',
      'overlap-449-kuerbis-edamame-reis-okonomiyaki',
      'overlap-450-forelle-schwarzwurzel-graupen-tarte',
      'overlap-451-kichererbsen-brokkoli-hafer-dumplings',
      'overlap-452-pute-rotkohl-teff-kofta',
      'overlap-453-linsen-steckrueben-dinkel-cobbler',
      'overlap-454-sellerie-apfel-linsen-roesti',
      'overlap-455-makrele-kuerbis-graupen-kedgeree',
      'overlap-456-pute-quitte-hirse-tagine',
      'overlap-457-rote-bete-ziegenkaese-buchweizen-piroggen',
      'overlap-458-tempeh-wirsing-reis-roulade',
      'overlap-459-seehecht-erbsen-hafer-fischkuechle',
      'overlap-460-kaninchen-mangold-polenta-schmortopf',
      'overlap-461-kichererbsen-fenchel-teff-socca',
      'overlap-462-muschel-sellerie-dinkel-chowder',
      'overlap-463-tofu-rotkohl-graupen-braten',
      'overlap-464-rind-kohlrabi-buchweizen-pelmeni',
      'overlap-465-kuerbis-maronen-linsen-boerek',
      'overlap-466-forelle-brokkoli-hirse-quiche',
      'overlap-467-haehnchen-schwarzwurzel-hafer-frikassee',
      'overlap-468-bohnen-rote-bete-dinkel-salat',
      'overlap-469-lamm-blumenkohl-bulgur-moussaka',
      'overlap-470-lupinen-lauch-kartoffel-kroketten',
      ...
      'overlap-494-kichererbsen-mangold-polenta-gnocchi',
      'overlap-495-kabeljau-kuerbis-hafer-kedgeree',
      'overlap-496-rote-bete-lupinen-buchweizen-piroggen',
      'overlap-497-pute-schwarzwurzel-graupen-frikadellen',
      'overlap-498-tofu-wirsing-reis-galette',
      'overlap-499-reh-maronen-hirse-pastete',
      'overlap-500-bohnen-fenchel-teff-gnocchi',
      'overlap-501-forelle-steckruebe-linsen-roulade',
      'overlap-502-blumenkohl-tempeh-dinkel-biryani',
      'overlap-503-kalb-kohlrabi-hafer-pilaw',
      'overlap-504-kuerbis-edamame-buchweizen-krapfen',
      'overlap-505-sardinen-lauch-kartoffel-clafoutis',
      'overlap-506-schwarze-bohnen-pastinaken-mais-chilaquiles',
      'overlap-507-haehnchen-rote-bete-graupen-dolma',
      'overlap-508-seitan-rosenkohl-hirse-pastete',
      'overlap-509-garnelen-mangold-linsen-lasagne',
      'overlap-510-quark-birne-mohn-hirseauflauf',
      'overlap-511-lamm-aubergine-teff-moussaka',
      'overlap-512-sellerie-erbsen-dinkel-bao',
    ])
  ...
  it('leitet die Preisgrundlage des vierundachtzigsten Batches ohne handgepflegte Abweichung aus den Zutaten ab', () => {
    for (const recipe of editorialRecipes.slice(-20)) {
  ...
  it('hält alle geprüften Rezepte mit explizitem Bildstatus im App-Katalog sichtbar', () => {
    expect(editorialAppRecipes).toHaveLength(500)
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('maronen-rosenkohl-graupenpfanne')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('huehnchen-bohnen-jambalaya')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('erbsen-tofu-dinkel-siu-mai-pak-choi')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lachs-rote-bete-kartoffel-galette-bohnensalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rind-sellerie-hirse-manti-paprikajoghurt')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kartoffel-linsen-dinkelwaffeln-pilzragout')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('garnelen-kuerbis-naturreis-congee-pak-choi')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('puten-wirsing-hirse-kibbeh-rote-bete-joghurt')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('miso-auberginen-edamame-reis')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('ricotta-spinat-knoedel-tomatenragout')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-aprikosen-gersten-pilaw')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tempeh-sauerkraut-kartoffel-pfanne')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('buchweizen-pilz-blini-rote-bete-quark')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('dorade-fenchel-bohnen-blech')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lauch-tofu-wan-tan-suppe')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('forellen-wirsing-kartoffel-auflauf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rinderhack-paprika-buchweizen-pfanne')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schweinegeschnetzeltes-kohlrabi-vollkornreis')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('birnen-bohnen-kartoffel-eintopf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('okra-linsen-hirse-eintopf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lupinen-kartoffel-gulasch')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('ziegenkaese-polenta-pfirsich')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rote-bete-bohnen-knoedel-wirsing')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('sardinen-tomaten-vollkorn-couscous')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('polenta-bohnen-tamale-auflauf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('gruenkern-zucchini-laibchen-tomatenbohnen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schweinefilet-linsen-aprikosen-tagine')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tofu-mais-okonomiyaki')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('seitan-pilz-wurzelgemuese-pie')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('zander-senfkohl-hirse-paeckchen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('linsen-mangold-moussaka')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kuerbis-walnuss-lobio')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-blumenkohl-buchweizen-blech')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('spinat-paneer-kofta-curry')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('gochujang-tempeh-glasnudelsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('ofenmakrele-rote-bete-meerrettich-hirse')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('fenchel-linsen-lasagne-ziegenkaese')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kartoffel-erbsen-samosa-blech')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rind-brokkoli-udon-pfanne')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kichererbsen-mangold-farinata')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('linsen-bulgur-koefte-schmorgemuese')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schweinehack-zitronengras-reisnudel-bowl')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lauch-linsen-buchweizen-galette')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('aloo-tikki-linsen-raita')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('garnelen-kuerbis-gnocchi-salbei')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('puten-sellerie-paprikasch-dinkelspaetzle')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kimchi-tofu-kartoffel-eintopf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('seelachs-linsen-frikadellen-fenchelsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('mais-spinat-quinoa-puffer-bohnen-salsa')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('weisse-bohnen-kuerbis-cassoulet')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('saibling-mais-kartoffel-chowder')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rind-wirsing-pflaumen-schmortopf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('dinkel-maultaschen-kuerbis-linsen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('muschel-paprika-fregola')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('brokkoli-kichererbsen-pakora-tomatenchutney')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rosenkohl-tempeh-bulgur-pilaw')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('mangold-kartoffel-souffle')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('puten-kohlrabi-rouladen-hirse')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('erdnuss-auberginen-kochbananen-topf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('gochujang-lachs-gerste-pak-choi')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('gefuellte-paprika-gruenkern-linsen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('spargel-linsen-erdbeer-salat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('forellen-hirse-kuechle-gurkensalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-rhabarber-kichererbsen-tagine')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tofu-ananas-naturreis-pfanne')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tintenfisch-bohnen-polenta')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('sellerie-linsen-strudel-apfelkraut')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('raeuchertofu-brokkoli-dinkel-blech')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kabeljau-linsen-kokos-paeckchen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('pastinaken-buchweizen-gnocchi')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('bohnen-rote-bete-falafel-hirse-taboule')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('zander-sauerkraut-kartoffel-groestl')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('puten-auberginen-bulgur-koefte-auflauf')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kartoffel-bohnen-pupusas-rotkohlsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lachs-spinat-hirse-terrine-fenchelsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rind-lauch-graupen-kroketten-rote-bete-joghurt')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tomaten-dill-gigantes-gerste-mangold')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lachs-kohl-okonomiyaki-edamame')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kuerbis-quark-knoedel-pilzragout')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('sellerie-adzuki-miso-blech-sesam-hirse')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('mangold-linsen-goezleme-paprika-joghurt')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-shiitake-gyoza-spitzkohlsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schwarze-bohnen-mais-arepas-kuerbis-salsa')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('ei-pilz-buchweizen-bibimbap')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schellfisch-lauch-hafer-crumble')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('weisse-bohnen-mangold-ribollita-polenta-crostini')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('forellen-spinat-kartoffel-piroggen-rote-bete-salat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rind-kuerbis-reis-kohlrouladen-paprikasauce')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rote-linsen-karotten-dhokla-erbsen-chutney')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('sardinen-fenchel-kartoffel-tortilla')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('zucchini-lamm-bulgur-rollen-tomatensauce')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('blumenkohl-linsen-socca-tomatenrelish')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rotbarsch-bohnen-rote-bete-paeckchen-dillkartoffeln')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('puten-mangold-linsen-crepes-paprikasauce')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('steckrueben-kichererbsen-roesti-apfelkraut')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('forellen-linsen-wan-tan-pak-choi-bruehe')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kuerbis-bohnen-dinkel-calzone-mangold')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kichererbsen-fenchel-panisse-ratatouille')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kalb-lauch-dinkel-frikassee-erbsen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('pflaumen-quark-buchweizen-auflauf-mandeln')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kartoffel-linsen-bao-rotkohl')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('muschel-bohnen-safranreis-fenchel')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('mais-quark-nocken-pilzragout')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-mais-dinkel-tamales-bohnen-salsa')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('seehecht-kartoffel-mais-empanadas-bohnensalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lauch-kichererbsen-hafer-kloesse-paprikakraut')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('miso-steckrueben-soba-edamame')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('garnelen-linsen-polenta-baellchen-fenchel')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schweinefilet-kuerbis-dinkelknoedel-wirsing')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kichererbsen-spinat-msemen-karotten-linsen-salat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('makrelen-kartoffel-kedgeree-erbsen')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('blumenkohl-kaese-graupen-kroketten-lauchcreme')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kartoffel-edamame-korokke-kohlsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('saibling-linsen-spinat-strudel-fenchel')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('auberginen-hirse-involtini-bohnencreme')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rote-bete-linsen-dinkel-pasteten-meerrettichkraut')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('seelachs-kichererbsen-baellchen-spinat-curry')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('puten-bohnen-paprika-pide-joghurtsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tempeh-kuerbis-reisnudel-laab-rotkohl')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('spinat-bohnen-mais-tschadi-paprikajoghurt')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kabeljau-erbsen-graupen-pie-lauch')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('tofu-rote-bete-buchweizen-nocken-meerrettichkraut')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('herings-apfel-lauch-dinkelflammkuchen-bohnensalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('pilz-linsen-kartoffel-zrazy-gurkenschmand')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('lupinen-spinat-dinkel-pelmeni-paprikabruehe')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-pastinaken-haferkuechle-lauchgemuese')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('bohnen-kuerbis-teff-injera-mangold')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('linsen-walnuss-cevapcici-ajvar-hirse')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('forellen-mais-buchweizen-tacos-krautsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('zucchini-ricotta-dinkel-ravioli-tomatensauce')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('kuerbis-kichererbsen-hirse-katsu-rotkohlsalat')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('sardinen-bohnen-vollkornpasta-fenchel')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-kichererbsen-dosa-spinat-chutney')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('rote-bete-buchweizen-galettes-linsencreme')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('seelachs-kartoffel-erbsen-pie')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('schweinefilet-apfel-wirsing-polenta')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('weisse-bohnen-spargel-dinkel-taboule-erdbeeren')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('haehnchen-zucchini-hirse-souvlaki-bohnencreme')
    expect(editorialAppRecipes.map(recipe => recipe.id)).toContain('raeucherforelle-kohlrabi-buchweizen-auflauf')
