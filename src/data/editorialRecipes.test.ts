...
describe('originaler redaktioneller Rezeptkatalog', () => {
  it('liefert achtundvierzig veröffentlichungsfähige Originalrezepte in dreizehn eigenständigen Batches', () => {
    ...
    expect(publishableEditorialRecipes).toHaveLength(48)
  })
