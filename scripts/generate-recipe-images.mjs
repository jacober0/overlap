...
export const recipeImageManifest = [
  ...
  { id: 'zucchini-kartoffel-roesti', dish: 'A charcoal plate with four small crisp golden potato-zucchini roesti, visibly shredded vegetable texture and browned lacy edges, beside a small bowl of white herb quark with chives and lemon zest; no meat.' },
